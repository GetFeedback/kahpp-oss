...
@Component
public final class SimpleHttpCallStepToKStream extends StepProcessorSupplier<SimpleHttpCall> {

  private final transient MeterRegistry meterRegistry;
  private final transient JacksonRuntime jacksonRuntime;

  public SimpleHttpCallStepToKStream(MeterRegistry meterRegistry, JacksonRuntime jacksonRuntime) {
    super(SimpleHttpCall.class);
    this.meterRegistry = meterRegistry;
    this.jacksonRuntime = jacksonRuntime;
  }

  @Override
  public ProcessorSupplier<JsonNode, JsonNode> supplier(SimpleHttpCall step, ChildStep child) {
