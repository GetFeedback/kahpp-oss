...
@SpringBootTest(classes = MoveFieldRecordTransformTest.KStreamsTest.class)
public class MoveFieldRecordTransformTest extends AbstractKaHPPTest {
  ...
  void transformWithSuccess() {
    ...
    assertThat(record.value()).isEqualTo("{\"fooCopy\":\"bar\"}");
  }
  ...
  public static class KStreamsTest extends KafkaStreamsTest {
    ...
    protected List<StepConfiguration<? extends Step>> getSteps() {
      final StepConfiguration<MoveFieldRecordTransform> copyFieldStep =
          new StepConfiguration<>(
              MoveFieldRecordTransform.class,
              "testMoveField",
